            ...
            <div className="p-0">
              <div className="overflow-x-auto max-h-[60vh]">
                <table className="w-full text-left border-collapse">
                  <thead className="bg-slate-50 sticky top-0 z-10">
                    <tr>
                      <th className="px-10 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-wider">Team Member</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {rosterLoading ? (
                       ...
                       <tr>
                         <td colSpan={2} className="px-10 py-20 text-center text-slate-400 italic">No team members worked on this client in {selectedMonth}.</td>
                       </tr>
                    ) : (
                      rosterData.map(emp => (

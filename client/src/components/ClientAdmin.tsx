    ...
    <div className="space-y-8 animate-in fade-in duration-500">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
          <table className="w-full text-left border-collapse">
            <thead className="bg-slate-50/50 dark:bg-slate-950/20">
              <tr>
                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Client</th>
                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-right">Total Hours</th>
                <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-center w-20">Action</th>
              </tr>
            </thead>
                  ...
                  >
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-2xl bg-orange-50 dark:bg-orange-950/30 text-orange-600 dark:text-orange-400 flex items-center justify-center font-bold text-sm">
                          {item.name[0]}
                        </div>
                        <span className="text-sm font-bold text-slate-900 dark:text-slate-100 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">{item.name}</span>
                      </div>
                    </td>
                    <td className="px-8 py-5 text-right">
                      <span className="text-sm font-mono font-black text-slate-900 dark:text-slate-100">{item.hours.toFixed(2)}</span>
                    </td>
                    <td className="px-8 py-5 text-center">
                      <div className="w-8 h-8 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center group-hover:bg-orange-100 dark:group-hover:bg-orange-950/50 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-all">
      ...
      <div className="space-y-6 pt-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">Client Database Manager</h3>
        ...
        {isAddFormOpen && (
          <form onSubmit={handleAddClient} className="bg-slate-50 dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800 p-6 rounded-2xl space-y-4 max-w-2xl animate-in fade-in slide-in-from-top-4 duration-300">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[32px] border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden">
          <div className="max-h-[500px] overflow-y-auto">
            <table className="w-full text-left border-collapse">
              <thead className="bg-slate-50 dark:bg-slate-950/20 sticky top-0 z-10">
                <tr>
                  <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Client Name</th>
                  <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Status</th>
                  <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Joining Date</th>
                  <th className="px-8 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Exit Date</th>
                  ...
                  allClients.map(c => {
                    ...
                    return (
                      <tr key={c.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-all">
                        <td className="px-8 py-5">
                          <div className="flex items-center gap-4">
                            <div className="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 flex items-center justify-center font-bold text-xs">
                              {c.name[0]}
                            </div>
                        ...
                        <td className="px-8 py-5 text-sm">
                          {c.exit_date ? (
                            <span className="bg-rose-100 dark:bg-rose-950/30 text-rose-700 dark:text-rose-400 text-[10px] font-black px-2.5 py-1 rounded-lg uppercase tracking-wider">
                              Exited ({c.exit_date.substring(0, 10)})
                            </span>
                          ) : (
                            <span className="bg-emerald-100 dark:bg-emerald-950/30 text-emerald-700 dark:text-emerald-400 text-[10px] font-black px-2.5 py-1 rounded-lg uppercase tracking-wider">
                              Active
                            </span>
                          )}
                        </td>
                        <td className="px-8 py-5 text-sm">
                          <input 
                            ...
                            className="px-3 py-1.5 text-xs font-bold text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-750 rounded-lg focus:ring-2 focus:ring-orange-600 outline-none bg-white dark:bg-slate-800 cursor-pointer"
                          />
                        </td>
                        <td className="px-8 py-5 text-sm">
                          <input 
      ...
      {isRosterOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 animate-in fade-in duration-300">
          ...
          />
          <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-[40px] shadow-2xl relative z-10 overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="px-10 py-8 bg-slate-950 text-white flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">Team Roster • {selectedMonth}</p>
                </div>
              </div>
              <button 
                onClick={() => setIsRosterOpen(false)}
            ...
            <div className="p-0">
              <div className="overflow-x-auto max-h-[60vh]">
                <table className="w-full text-left border-collapse">
                  <thead className="bg-slate-50 dark:bg-slate-950/20 sticky top-0 z-10">
                    <tr>
                      <th className="px-10 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider">Team Member</th>
                      <th className="px-10 py-5 text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wider text-right">Hours</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {rosterLoading ? (
                       ...
                       <tr>
                         <td colSpan={2} className="px-10 py-20 text-center text-slate-400 dark:text-slate-500 italic">No team members worked on this client in {selectedMonth}.</td>
                       </tr>
                    ) : (
                      rosterData.map(emp => (
                        <tr key={emp.email} className="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                          <td className="px-10 py-5">
                            <div className="flex flex-col">
                              <span className="text-sm font-bold text-slate-900 dark:text-slate-100">{emp.name}</span>
                              <span className="text-xs text-slate-400 dark:text-slate-500 font-medium">{emp.email}</span>
                            </div>
                          </td>
                          <td className="px-10 py-5 text-right">
                            <span className="text-sm font-mono font-black text-orange-600 dark:text-orange-400">{emp.hours.toFixed(2)}</span>
                          </td>
                        </tr>
                      ))
                    )}
                  ...
                  {!rosterLoading && rosterData.length > 0 && (
                    <tfoot className="bg-slate-50 dark:bg-slate-950/20">
                      <tr>
                        <td className="px-10 py-5 text-sm font-bold text-slate-900 dark:text-slate-100 tracking-tight uppercase">Total Client Hours</td>
                        <td className="px-10 py-5 text-right text-sm font-mono font-black text-slate-900 dark:text-slate-100">
            ...
            <div className="p-8 bg-slate-50 dark:bg-slate-950/20 border-t border-slate-100 dark:border-slate-800 text-center">
              <button 
                onClick={() => setIsRosterOpen(false)}
                className="bg-slate-900 dark:bg-slate-800 text-white px-10 py-3 rounded-2xl text-sm font-bold hover:bg-slate-800 dark:hover:bg-slate-700 transition-all shadow-xl shadow-slate-200 dark:shadow-none"
              >
                Done Viewing
              </button>
            </div>

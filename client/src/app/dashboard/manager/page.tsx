      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <div className="flex bg-white border border-slate-200 rounded-xl shadow-sm relative z-[100] overflow-visible">
          ...
          <select 
            ...
            className="px-4 py-2 text-sm font-bold bg-transparent border-none focus:ring-0 outline-none cursor-pointer text-indigo-600 min-w-[90px] rounded-r-xl"
          >
        ...
        <div className="p-8">
          {activeTab === 'self' ? (
            <div className="space-y-6 animate-in slide-in-from-right duration-300">
              ...
              {myLoading ? (
                <Loader size="lg" text="Loading allocations..." />
              ) : (
            ...
            <div className="space-y-12">
              {selectedMember ? (
                <div className="space-y-6 animate-in slide-in-from-right duration-300">
                  ...
                  {loading ? (
                    <Loader size="lg" text="Gathering member logs..." />
                  ) : (
                ...
                <div className="space-y-12">
                  ...
                  {activeEmailsLoading ? (
                    ...
                    <ErrorDisplay message={activeEmailsError} onRetry={fetchActiveEmails} />
                  ) : (
                    <>
                      {/* Active Section */}
